...
export const contracts_pages: KirletPageDecl[] = [
  {
    id: "hr.contracts",
    path: "contracts",
    ...
    build: () =>
      build_feature_shell_page({
        ...
        props: {
          ...
          data: {
            list: `${API}/contracts`,
            record: `${API}/contracts/:id`,
            create: { method: "POST", action: `${API}/contracts` },
            update: { method: "PATCH", action: `${API}/contracts/:id` },
            delete: { method: "DELETE", action: `${API}/contracts/:id` },
          },
          table: {
            columns: [
