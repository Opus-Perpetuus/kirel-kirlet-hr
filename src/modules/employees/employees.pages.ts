...
export const employees_pages: KirletPageDecl[] = [
  {
    id: "hr.employees",
    path: "employees",
    ...
    build: () =>
      build_feature_shell_page({
        ...
        props: {
          ...
          data: {
            list: `${API}/employees`,
            record: `${API}/employees/:id`,
            create: { method: "POST", action: `${API}/employees` },
            update: { method: "PATCH", action: `${API}/employees/:id` },
            delete: { method: "DELETE", action: `${API}/employees/:id` },
          },
          table: {
            columns: [
          ...
          form: {
            fields: [
              ...
              },
              {
                ...
                component: "input-menu",
                label: "Puesto",
                optionsSource: `${API}/positions?as=options`,
              },
              {
                name: "manager_id",
                component: "input-menu",
