...
export function build_incidents_page(): NoxPageDescriptor {
  ...
  return build_feature_shell_page({
    ...
    props: {
      ...
      data: {
        ...
        record: `${API_BASE}/incidents/:id`,
        create: { method: "POST", action: `${API_BASE}/incidents` },
        update: { method: "PATCH", action: `${API_BASE}/incidents/:id` },
        delete: { method: "DELETE", action: `${API_BASE}/incidents/:id` },
      },
      table: {
        columns: [
        ...
        detail: [
          {
            ...
            invoke: {
              method: "POST",
              action: `${API_BASE}/incidents/:id/review`,
            },
            refresh: "record",
          },
          {
            ...
            invoke: {
              method: "POST",
              action: `${API_BASE}/incidents/:id/start`,
            },
            refresh: "record",
          },
          {
            ...
            invoke: {
              method: "POST",
              action: `${API_BASE}/incidents/:id/resolve`,
            },
            refresh: "record",
          },
          {
            ...
            invoke: {
              method: "POST",
              action: `${API_BASE}/incidents/:id/close`,
            },
            refresh: "record",
          },
          {
            ...
            invoke: {
              method: "POST",
              action: `${API_BASE}/incidents/:id/cancel`,
            },
            refresh: "record",
          },
        ],
...
// (o-----------------------------------------------------------/\-----o)
//   #endregion INCIDENTS DESCRIPTORS
// (o==================================================================o)
